...
function [Samples,AllChains_VbNP]=sample_grbm_PT_beta_0611vec(Weights_HbV_ini, VBias_Vb1_ini, HBias_Hb1_ini,...
    ...
    Samples = zeros( grbm.nV, grbm.BatchSize );
    Swaps=0;
    
    % Start Chain
    nSamplingSteps=grbm.BatchSize+grbm.BurnIn;
    for iSamplingStep=1:nSamplingSteps
        ...
        if iSamplingStep>grbm.BurnIn
            Samples(:,iSamplingStep-grbm.BurnIn)=AllChains_VbNP(:,grbm.nPTChains);
        end
