...
function [Samples,AllChains]=sample_grbm_PT_beta_0611(Weights_HbV_ini, VBias_Vb1_ini, HBias_Hb1_ini,...
    ...
    Weights_HbV=cell(grbm.nPTChains,1);
    VBias_Vb1=cell(grbm.nPTChains,1);
    HBias_Hb1=cell(grbm.nPTChains,1);
    Sigmas_Vb1=cell(grbm.nPTChains,1);
    ...
    for iSamplingStep=1:nSamplingSteps
        ...
        Samples(:,iSamplingStep)=AllChains(:,grbm.nPTChains);
